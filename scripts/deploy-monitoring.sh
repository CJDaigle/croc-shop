...
echo ""
echo "Monitoring namespace: croc-shop-monitoring"
echo "Scraping metrics from all Crocs Shop namespaces"
echo ""
echo "Access dashboards:"
echo "  Prometheus: kubectl port-forward -n croc-shop-monitoring svc/prometheus 9090:9090"
echo "  Grafana: kubectl port-forward -n croc-shop-monitoring svc/grafana 3000:3000"
echo ""
